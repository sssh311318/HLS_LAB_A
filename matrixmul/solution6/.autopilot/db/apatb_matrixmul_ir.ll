; ModuleID = '/mnt/HLSNAS/02.CtINEm/m110061608/vitis_HLS/matrixmul/solution6/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @copy_in([3 x [3 x i8]]* nonnull %0, [3 x i24]* nonnull align 512 %a_copy1, [3 x [3 x i8]]* nonnull %1, [3 x i8]* nonnull align 512 %b_copy_0, [3 x i8]* nonnull align 512 %b_copy_1, [3 x i8]* nonnull align 512 %b_copy_2, [3 x [3 x i16]]* nonnull %2, [3 x [3 x i16]]* nonnull align 512 %res_copy)
  %a_copy.gep2 = getelementptr [3 x i24], [3 x i24]* %a_copy1, i64 0, i32 0
  %3 = getelementptr inbounds [3 x [3 x i16]], [3 x [3 x i16]]* %res_copy, i32 0, i32 0
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i24* %a_copy.gep2, i32 0, i32 1, i32 0) ], !dbg !5
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"([3 x i8]* %b_copy_0, i32 0, i32 1, i32 0, i1 false) ], !dbg !376
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"([3 x i8]* %b_copy_1, i32 0, i32 1, i32 0, i1 false) ], !dbg !376
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"([3 x i8]* %b_copy_2, i32 0, i32 1, i32 0, i1 false) ], !dbg !376
  call void @apatb_matrixmul_hw([3 x i24]* %a_copy1, [3 x i8]* %b_copy_0, [3 x i8]* %b_copy_1, [3 x i8]* %b_copy_2, [3 x i16]* %3)
  call void @copy_back([3 x [3 x i8]]* %0, [3 x i24]* %a_copy1, [3 x [3 x i8]]* %1, [3 x i8]* %b_copy_0, [3 x i8]* %b_copy_1, [3 x i8]* %b_copy_2, [3 x [3 x i16]]* %2, [3 x [3 x i16]]* %res_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a3a3i8.9.10([3 x [3 x i8]]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a3a3i8.13.14([3 x i24]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [3 x [3 x i8]]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([3 x [3 x i8]]* noalias readonly "orig.arg.no"="0", [3 x i24]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [3 x [3 x i8]]* noalias readonly "orig.arg.no"="2", [3 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [3 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [3 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_2, [3 x [3 x i16]]* noalias readonly "orig.arg.no"="4", [3 x [3 x i16]]* noalias align 512 "orig.arg.no"="5") #4 {
entry:
  call void @onebyonecpy_hls.p0a3a3i8.13.14([3 x i24]* align 512 %1, [3 x [3 x i8]]* %0)
  call void @onebyonecpy_hls.p0a3a3i8.3.4([3 x i8]* align 512 %_0, [3 x i8]* align 512 %_1, [3 x i8]* align 512 %_2, [3 x [3 x i8]]* %2)
  call fastcc void @onebyonecpy_hls.p0a3a3i16([3 x [3 x i16]]* align 512 %4, [3 x [3 x i16]]* %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a3a3i8.19.20([3 x [3 x i8]]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [3 x i24]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [3 x [3 x i8]]* %0, null
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([3 x [3 x i8]]* noalias "orig.arg.no"="0", [3 x i24]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [3 x [3 x i8]]* noalias "orig.arg.no"="2", [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_2, [3 x [3 x i16]]* noalias "orig.arg.no"="4", [3 x [3 x i16]]* noalias readonly align 512 "orig.arg.no"="5") #5 {
entry:
  call void @onebyonecpy_hls.p0a3a3i8.19.20([3 x [3 x i8]]* %0, [3 x i24]* align 512 %1)
  call void @onebyonecpy_hls.p0a3a3i8.9.10([3 x [3 x i8]]* %2, [3 x i8]* align 512 %_0, [3 x i8]* align 512 %_1, [3 x i8]* align 512 %_2)
  call fastcc void @onebyonecpy_hls.p0a3a3i16([3 x [3 x i16]]* %3, [3 x [3 x i16]]* align 512 %4)
  ret void
}

declare void @apatb_matrixmul_hw([3 x i24]*, [3 x i8]*, [3 x i8]*, [3 x i8]*, [3 x i16]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([3 x [3 x i8]]* noalias "orig.arg.no"="0", [3 x i24]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [3 x [3 x i8]]* noalias "orig.arg.no"="2", [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [3 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_2, [3 x [3 x i16]]* noalias "orig.arg.no"="4", [3 x [3 x i16]]* noalias readonly align 512 "orig.arg.no"="5") #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0a3a3i16([3 x [3 x i16]]* %3, [3 x [3 x i16]]* align 512 %4)
  ret void
}

define void @matrixmul_hw_stub_wrapper([3 x i24]*, [3 x i8]*, [3 x i8]*, [3 x i8]*, [3 x i16]*) #6 {
entry:
  %5 = alloca [3 x [3 x i8]]
  %6 = alloca [3 x [3 x i8]]
  %7 = bitcast [3 x i16]* %4 to [3 x [3 x i16]]*
  call void @copy_out([3 x [3 x i8]]* %5, [3 x i24]* %0, [3 x [3 x i8]]* %6, [3 x i8]* %1, [3 x i8]* %2, [3 x i8]* %3, [3 x [3 x i16]]* null, [3 x [3 x i16]]* %7)
  %8 = bitcast [3 x [3 x i8]]* %5 to [3 x i8]*
  %9 = bitcast [3 x [3 x i8]]* %6 to [3 x i8]*
  %10 = bitcast [3 x [3 x i16]]* %7 to [3 x i16]*
  call void @matrixmul_hw_stub([3 x i8]* %8, [3 x i8]* %9, [3 x i16]* %10)
  call void @copy_in([3 x [3 x i8]]* %5, [3 x i24]* %0, [3 x [3 x i8]]* %6, [3 x i8]* %1, [3 x i8]* %2, [3 x i8]* %3, [3 x [3 x i16]]* null, [3 x [3 x i16]]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/mnt/HLSNAS/02.CtINEm/m110061608/vitis_HLS/matrixmul/solution6/directives.tcl", directory: "/mnt/HLSNAS/02.CtINEm/m110061608/vitis_HLS")
...
!27 = !DIFile(filename: "/mnt/HLSNAS/02.CtINEm/m110061608/vitis_HLS/matrixmul/solution6/.autopilot/db/matrixmul.pp.0.cpp", directory: "/mnt/HLSNAS/02.CtINEm/m110061608/vitis_HLS")
...
!376 = !DILocation(line: 9, column: 9, scope: !6)
