...
set C_modelArgList {
	{ sub_ln60 int 4 regular  }
	{ a int 8 regular {array 9 { 1 3 } 1 1 }  }
	{ zext_ln56 int 2 regular  }
	{ b int 8 regular {array 9 { 1 3 } 1 1 }  }
	{ p_out int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln60", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "a", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln56", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln60", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "sub_ln60", "role": "default" }} , 
 	...
 	{ "name": "zext_ln56", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln56", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sub_ln60 { ap_none {  { sub_ln60 in_data 0 4 } } }
	a { ap_memory {  { a_address0 mem_address 1 4 }  { a_ce0 mem_ce 1 1 }  { a_q0 in_data 0 8 } } }
	zext_ln56 { ap_none {  { zext_ln56 in_data 0 2 } } }
