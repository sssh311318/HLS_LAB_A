; ModuleID = '/mnt/HLSNAS/02.CtINEm/m110061608/vitis_HLS/matrixmul/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([3 x [3 x i8]]* noalias, [3 x [3 x i8]]* noalias readonly align 512, [3 x [3 x i8]]* noalias, [3 x [3 x i8]]* noalias readonly align 512, [3 x [3 x i16]]* noalias, [3 x [3 x i16]]* noalias readonly align 512) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([3 x [3 x i8]]* noalias, [3 x [3 x i8]]* noalias readonly align 512, [3 x [3 x i8]]* noalias, [3 x [3 x i8]]* noalias readonly align 512, [3 x [3 x i16]]* noalias, [3 x [3 x i16]]* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a3a3i16([3 x [3 x i16]]* %4, [3 x [3 x i16]]* align 512 %5)
  ret void
}
