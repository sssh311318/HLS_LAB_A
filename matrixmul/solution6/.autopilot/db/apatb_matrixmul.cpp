...
#define AUTOTB_TVIN_b_0 "../tv/cdatafile/c.matrixmul.autotvin_b_0.dat"
#define AUTOTB_TVOUT_b_0 "../tv/cdatafile/c.matrixmul.autotvout_b_0.dat"
#define AUTOTB_TVIN_b_1 "../tv/cdatafile/c.matrixmul.autotvin_b_1.dat"
#define AUTOTB_TVOUT_b_1 "../tv/cdatafile/c.matrixmul.autotvout_b_1.dat"
#define AUTOTB_TVIN_b_2 "../tv/cdatafile/c.matrixmul.autotvin_b_2.dat"
#define AUTOTB_TVOUT_b_2 "../tv/cdatafile/c.matrixmul.autotvout_b_2.dat"
...
#define AUTOTB_TVOUT_PC_b_0 "../tv/rtldatafile/rtl.matrixmul.autotvout_b_0.dat"
#define AUTOTB_TVOUT_PC_b_1 "../tv/rtldatafile/rtl.matrixmul.autotvout_b_1.dat"
#define AUTOTB_TVOUT_PC_b_2 "../tv/rtldatafile/rtl.matrixmul.autotvout_b_2.dat"
...
extern "C" void matrixmul_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
tr.import<1>((char*)__xlx_apatb_param_b_0, 3, 0);
  }
...
tr.import<1>((char*)__xlx_apatb_param_b_1, 3, 0);
  }
...
transaction<8> tr(3);
  __xlx_offset_byte_param_b_2 = 0*1;
  if (__xlx_apatb_param_b_2) {
tr.import<1>((char*)__xlx_apatb_param_b_2, 3, 0);
  }
...
if (__xlx_apatb_param_b_2) {
for (size_t i = 0; i < 3; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_b_2 + i * 1;
std::string s = formatData(pos, 8);
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_res + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_res, s);
}
}
}
...
matrixmul_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b_0, __xlx_apatb_param_b_1, __xlx_apatb_param_b_2, __xlx_apatb_param_res);
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_res + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVOUT_res, s);
}
}
}
